...
LIBSEL4_INLINE_FUNC void seL4_UintrSend(seL4_Word index) {
    uipi_send(index);
}

LIBSEL4_INLINE_FUNC void seL4_UintrRecv(seL4_CPtr src, seL4_Word *sender) {
    seL4_Recv(src, sender);
}

LIBSEL4_INLINE_FUNC void seL4_UintrNBRecv(seL4_Word *sender) {
    *sender = uipi_read();
}
